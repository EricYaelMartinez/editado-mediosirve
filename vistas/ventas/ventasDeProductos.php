...
<div class="row">
	<div class="col-sm-4">
		<form id="frmVentasProductos">
			...
			<input type="number" class="form-control input-sm" id="cantidadVender" name="cantidadVender">
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#btnAgregaVenta').click(function(){
			...
			//modicad000000000000000000000
			var cantidadVenta = parseInt($('#cantidadVenta').val());
			var cantidadDisponible = parseInt($('#cantidadV').val());

			if (cantidadVenta > cantidadDisponible) {
				alertify.alert("La cantidad a vender supera la cantidad disponible");
				return false;
			}
			////termina
			...
			$.ajax({
				...
				success:function(r){
					...
					//fin cambio
					//$('#tablaVentasTempLoad').load("ventas/tablaVentasTemp.php");loquite un ratito
				}
			});
		});
